...
func main() {
	...
	r.GET("/students", func(c *gellen.Context) {
		c.HTML(http.StatusOK, "arr.tmpl", gellen.H{
			"title":  "gellen",
			"stuArr": [2]*student{stu1, stu2},
		})
	})

	r.GET("/date", func(c *gellen.Context) {
		c.HTML(http.StatusOK, "custom_func.tmpl", gellen.H{
			"title": "gellen",
